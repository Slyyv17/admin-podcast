...
export default function PodcastDetailPage() {
  ...
  return (
    <main className="min-h-screen text-white pry-ff">
      ...
      >
        ...
        {/* New Episode Modal Button */}
        <button
          onClick={() => setIsModalOpen(true)}
          className="absolute bottom-6 right-6 z-50 px-6 py-2 bg-[var(--acc-clr)] text-white font-semibold rounded-lg hover:bg-red-900 cursor-pointer transition flex items-center gap-2"
        >
          <Plus size={16} />
          New Episode
        </button>
      ...
      {/* Description Section */}
      <section className="px-6 mx-auto py-12">
        <div className="bg-gray-800 bg-opacity-70 p-8 rounded-xl shadow-lg backdrop-blur-md">
          <h2 className="text-2xl font-semibold mb-4 text-red-400">About This Podcast</h2>
          ...
          {isLongDescription && (
            <button
              ...
              className="mt-4 text-red-400 hover:text-blue-300 font-medium transition-colors duration-200 focus:outline-none"
            >
      ...
      <section className="mx-auto px-6 pb-16">
        <div className="bg-gray-800 bg-opacity-60 p-6 rounded-xl shadow-lg backdrop-blur-md">
          <a
